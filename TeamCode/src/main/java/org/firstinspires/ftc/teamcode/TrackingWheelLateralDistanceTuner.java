...
import static org.firstinspires.ftc.teamcode.DriveConstants.LATERAL_DISTANCE;
 ...
 *
 * 6. Spin the bot NUM_TURNS times, counterclockwise. Make sure to keep track of these turns.
 *
 * 7. Once the bot has finished spinning NUM_TURNS times, press A to finishing the routine. The
...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && !tuningFinished) {
            ...
            wheelPowers = MyMathLib.mecMath(0, 0, (gamepad1.left_trigger - gamepad1.right_trigger));
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * LATERAL_DISTANCE);
