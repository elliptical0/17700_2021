...
public class MyMecanumDrive extends MecanumDrive {
    ...
    public MyMecanumDrive(HardwareMap hardwareMap) {
        ...
        System.out.println(hardwareMap.hashCode());
        ...
        // TO/DO: if your hub is mounted vertically, remap the IMU axes so that the z-axis points
        // upward (normal to the floor) using a command like the following:
        // BNO055IMUUtil.remapAxes(imu, AxesOrder.XYZ, AxesSigns.NPN);

        motors = new ArrayList();
        for(int i = 4; i > 0; i--) {
            motors.add(hardwareMap.get(DcMotorEx.class, "motor" + (i%4)));
            MotorConfigurationType motorConfigurationType = motors.get(4 - i).getMotorType().clone();
            motorConfigurationType.setAchieveableMaxRPMFraction(1.0);
            motors.get(4 - i).setMotorType(motorConfigurationType);
        }
