...
public class ImgFilter extends OpenCvPipeline {
	...
	public Mat processFrame(Mat source0) {
		...
		double blurRadius = 9.909909909909917;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {8.093525179856115, 27.95221843003414};
		double[] hsvThresholdSaturation = {107.77877697841726, 204.95733788395904};
